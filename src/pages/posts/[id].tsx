    ...
    return (
      <Container>
        ...
        <Main>
          ...
          <Link href="/">
            <a>
              <svg className="fill-current text-white hover:fill-current hover:text-purple-600 transition duration-300 ease-in-out" width="50" height="50" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd" clip-rule="evenodd">
          ...
          <article className="container max-100">
